...
const Settings = () => {
  ...
  const switchActiveStyles = "bg-yellow-400 justify-end bg-opacity-90";
  const switchPassiveStyles = "bg-slate-950 justify-start bg-opacity-100";

  return (
    <section className="bg-gray-900 text-slate-300 rounded-xl flex flex-col sm:w-full md:w-60 lg:min-w-[20rem] px-6 py-5 gap-4 h-full">
      <motion.div
